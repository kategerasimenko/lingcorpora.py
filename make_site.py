# https://github.com/chrisalbon/mlai/blob/master/make_site.ipynb
...
for file in files:
    ...
    #with open(markdown_file, 'r',encoding='utf-8') as fin:
    #    data = fin.read().splitlines(True)
    #with open(markdown_file, 'w',encoding='utf-8') as fout:
    #    fout.writelines(data[1:])

# Compile site
generate_site = os.system('pelican content -o docs -s pelicanconf.py')
